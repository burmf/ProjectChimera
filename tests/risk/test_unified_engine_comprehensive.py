...
from project_chimera.domains.market import OHLCV, Signal, SignalStrength, SignalType
...
class TestUnifiedRiskEngine:
    ...
    def test_update_trade_result(self, risk_engine):
        ...
        risk_engine.dd_guard.current_equity
    ...
    def test_hot_reload_config(self, risk_engine):
        ...
        risk_engine.config.kelly_base_fraction
