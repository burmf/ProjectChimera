...
from ..orchestrator_4layer import (
    ProjectChimera4LayerOrchestrator as TradingOrchestrator,
)
...
class TradingSystemController:
    ...
    async def start_system(self) -> dict[str, Any]:
        ...
        try:
            ...
            from ..orchestrator_4layer import OrchestratorConfig

            config = OrchestratorConfig(
                trading_symbols=["BTCUSDT_SPBL", "ETHUSDT_SPBL"],
            ...
            return {
                ...
                "symbols": self.orchestrator.config.trading_symbols,
            }
    ...
    try:
        return JSONResponse(
            content={
                ...
                "start_time": (
                    controller.start_time.isoformat() if controller.start_time else None
                ),
                "uptime_seconds": (
                    (datetime.now() - controller.start_time).total_seconds()
