...
class NewsRSSCollector:
    ...
    def __init__(self, redis_pipeline: RedisStreamPipeline):
        ...
        self.crypto_keywords = {
            ...
            "binance", "coinbase", "ftx", "kraken", "whale", "dex", "yield",
            "staking", "mining", "halving", "fork", "usdt", "usdc", "stablecoin"
        }
        
        self.forex_keywords = {
            "forex", "fx", "usd", "eur", "jpy", "gbp", "aud", "cad", "chf",
            "central bank", "fed", "boj", "ecb", "interest rate", "monetary policy",
            "inflation", "gdp", "employment", "nonfarm", "cpi", "ppi", "retail sales"
        }
    ...
    async def start(self, collection_interval_hours: int = 1):
        ...
        logger.info(f"Starting RSS news collector (interval: {collection_interval_hours}h)")
    ...
    async def _collection_loop(self, interval_hours: int):
        ...
        while self._running:
            try:
                ...
                logger.info(f"Collected {total_articles} articles in {collection_time:.1f}s")
    ...
    async def _process_article(self, entry, source: NewsSource) -> Optional[NewsMessage]:
    ...
    def _calculate_relevance(self, title: str, content: str) -> float:
        ...
        trading_terms = ["trading", "price", "volume", "breakout", "support", "resistance", "bull", "bear"]
