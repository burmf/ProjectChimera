...
class CMEGapStrategy(Strategy):
    ...
    def validate_config(self) -> None:
        ...
        self.params.setdefault('gap_fill_timeframe', 168)  # Hours to expect gap fill (1 week)
    ...
    def generate_signal(self, market_data: MarketFrame) -> Optional[Signal]:
        ...
        if not market_data.ohlcv_1h or len(market_data.ohlcv_1h) < 72:  # Need 3 days of data
            return None
    ...
    def _detect_cme_gap(self, candles: List) -> Optional[Dict[str, Any]]:
    ...
    def _get_cme_futures_price(self, symbol: str) -> Optional[float]:
...
def create_cme_gap_strategy(config: Optional[Dict[str, Any]] = None) -> CMEGapStrategy:
